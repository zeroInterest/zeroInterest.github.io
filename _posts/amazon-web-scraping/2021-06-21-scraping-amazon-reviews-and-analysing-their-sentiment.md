...
Again, in this case it makes no difference which review we inspect, as they will all follow the same structure.  <img src="/assets/img/amazon-web-scraping/selectItem.png" alt="select item icon">
